...
import { FiClock, FiDownload, FiFilter, FiRefreshCw } from 'react-icons/fi';
...
export default function AutoPayPage() {
  return (
    <VerificationRequired>
      <DashboardLayout>
      <PageHeader>
        <PageTitle>AutoPay Setup</PageTitle>
        <PageSubtitle>Configure and manage automated recurring payments</PageSubtitle>
      </PageHeader>

      <StatsGrid>
        <StatCard initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0 }}>
          <StatValue>0</StatValue>
          <StatLabel>Active AutoPay</StatLabel>
        </StatCard>
      ...
      <Card>
        ...
        <EmptyState>
          <FiClock />
          <h3>No AutoPay Configured</h3>
          <p>Set up automated recurring payments to see them here</p>
        </EmptyState>
      </Card>
    </DashboardLayout>
    </VerificationRequired>
